          ...
          <div className="col-sm-16 col-md-6">
            <Box component="form" sx={box}>
              ...
              <TextField
                ...
                sx={tf}
              />
              <Button component="label" variant="contained" sx={btn}>
                Submit
              </Button>
            </Box>
          </div>
            ...
            <ul className="m-0 p-0">
              <li className="list-card">
                ...
                <p className="fw-bold mb-0">
                  <PhoneIcon className="crc-btn p-1" />
                  <a href="tel:014168319"> 01-4168319 </a>
                  <span> , </span>
                  <a href="tel:9863448300"> 9863448300 </a>
                  <span> , </span>
                  <a href="tel:9815150952"> 9815150952 </a>
                  <span> , </span>
                </p>
              </li>
              <li className="list-card">
                ...
                <p className="mb-0 lh-base">
                  Visit Us to location provided below:
                </p>
                <p className="fw-bold mb-0">
                  <FmdGoodIcon className="crc-btn p-1" />
                  <a
              ...
              <li className="list-card">
                ...
                <p className="fw-bold mb-0">
                  <VideoCallIcon className="crc-btn p-1" />
                  <a href="#">Open Chat Head</a>
                </p>
              </li>
              {/* <li className="list-card">
