  ...
  useEffect(() => {
    ...
    if (item) {
      ...
      setContent({
        ...
        maintitlecontent: item?.maintitlecontent,
      });
    }
  }, []);
  return (
      ...
      <section>
        <div className="cover-bg">
          <div className="container py-5 ">
            <h1 className="fw-bold text-center">{content?.maintitle}</h1>
            <p className="fw-bold fs-5 text-center">
              Discover Our Story: Who We Are and What We Stand For.
            </p>
            <p className="text-center lh-base">{content?.maintitlecontent}</p>
          </div>
              ...
              <div className="row  my-5 d-flex align-items-center">
                <div className="col-md-6 col-sm-12 relative text-center">
                  <img
                    className="side-img"
                    src={
                      "https://images.pexels.com/photos/13092792/pexels-photo-13092792.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                    }
                    alt="usa"
                  ></img>
                  <img
              ...
              <div className="row  my-5 d-flex align-items-center">
                ...
                <div className="col-md-6 col-sm-12">
                  ...
                  <p className="lh-base">
                    <ol>
                      <li>
                        1. Register With An Education Counselor to apply for a
                        Canada Student Visa.
                      </li>
                      <li>
                        2. Apply To Institutions With Our Help (We Have Great
                        Working Relationships With Many Canadian Universities).
                      </li>
                      <li>
                        3. Take up an English Test (IELTS, SAT, TOEFL or PTE).
                      </li>
